function update() {
  ...
  document.getElementById('AutoClickCost').innerHTML = ((autoClick+1) * 24) + " Cookies";

  document.getElementById('FactoryAmount').innerHTML = "You Own " + factories + " Factories";
  document.getElementById('FactoryCost').innerHTML = ((factories+1) * 40) + " Cookies";
  ...
  document.getElementById('MinerCost').innerHTML = ((miners+1) * 30) + " Coins";
